package io.edenx.androidpark.feature.paging
...
import io.edenx.androidpark.feature.paging.databinding.ActivityPagingBinding
import io.edenx.androidpark.feature.paging.databinding.ItemDoggoBinding
...
class PagingActivity : BaseActivity<ActivityPagingBinding>(ActivityPagingBinding::inflate) {
    ...
    class DoggoImageAdapter :PagingDataAdapter<DoggoImageModel, RecyclerView.ViewHolder>(BasePagingDataAdapter.BaseComparator()) {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            return ItemViewHolder(ItemDoggoBinding.inflate(LayoutInflater.from(parent.context), parent, false))
        }
        ...
        class ItemViewHolder(private val binding: ItemDoggoBinding) : RecyclerView.ViewHolder(binding.root) {
            fun binDate(item: DoggoImageModel?) {
                Glide.with(binding.imgDoggo)
                    .load(item?.url)
                    .into(binding.imgDoggo)
            }
        }
    }
}