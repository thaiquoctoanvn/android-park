...
class GooglePayUtil @Inject constructor(
    ...
    /**
     * Was a constructor parameter, but the Hilt provider only ever passed the
     * Context, so it was always null. Kept as a property to preserve that
     * behaviour, and to leave one obvious place to set a real merchant.
     */
